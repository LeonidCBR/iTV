...
// TODO: Split ChannelError to NetworkError, ChannelError and PersistentError
...
//            return NSLocalizedString("Ошибка сети. \(sessionError.localizedDescription)", comment: "")
          ...
          case .unauthorized:
            return NSLocalizedString("Не верные имя пользователя или пароль.",
                                     comment: "")
          case .unhandledError(let status):
            return NSLocalizedString("Неизвестная ошибка сети. Код ошибки: \(status)",
                                     comment: "")
          case .unexpectedData:
            return NSLocalizedString("Полученные данные от сервера не возможно прочитать.",
                                     comment: "")
//          case .unexpectedJSON:
//            return NSLocalizedString("Полученные данные от сервера не возможно обработать.",
//                                     comment: "")
          case .unexpectedURL:
              return NSLocalizedString("Не верная строка адреса для запроса.",
                                       comment: "")
          case .missingData:
          ...
          case .wrongDataFormat(let error):
              return NSLocalizedString(
                ...
                comment: "")
//          case .creationError:
//              return NSLocalizedString("Failed to create a new object.",
//                                       comment: "")
          case .batchInsertError:
              return NSLocalizedString("Failed to execute a batch insert request.",
                                       comment: "")
//          case .batchDeleteError:
//              return NSLocalizedString("Failed to execute a batch delete request.",
//                                       comment: "")
          case .persistentHistoryChangeError:
